...
(function () { return __awaiter(void 0, void 0, void 0, function () {
    var options, cwd, head, file, help, list, info, content;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                cwd = options['--cwd'] || options['-c'] || process.cwd();
                ...
                if (!head) return [3 /*break*/, 2];
                return [4 /*yield*/, (0, index_1.gInfo)(head, cwd)];
            case 1:
                list = _a.sent();
                if (file) {
                    info = list.treeMap[file];
                    content = (0, index_1.showGInfo)(info.hash, cwd);
                    console.log(content);
                }
                else {
                    console.log(list);
